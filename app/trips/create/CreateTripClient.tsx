...
export default function CreateTripClient() {
  ...
  return (
    <section className="mx-auto max-w-xl px-6 py-16">
      <h1 className="mb-8 text-3xl font-bold text-slate-900">Plan a New Trip</h1>

      {submitted ? (
        <div className="anim-scale-in rounded-lg bg-emerald-50 p-5 text-emerald-700">
          <h2 className="font-semibold">Trip created successfully!</h2>
          <p className="mt-1 text-sm">Redirecting you to payment...</p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="brand-button w-full rounded-full bg-sky-600 px-6 py-3 text-sm font-semibold text-white hover:bg-sky-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
